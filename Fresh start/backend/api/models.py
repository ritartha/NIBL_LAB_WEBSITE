...
class Member(models.Model):
    ...
    photo = models.URLField(blank=True, help_text="Photo URL")
...
class AccommodationPerson(models.Model):
    """Each person needing accommodation, linked to a BeamTimeRequest."""
    ...
    class Meta:
        verbose_name_plural = "Accommodation People"
...
class ResearchArea(models.Model):
    title = models.CharField(max_length=200)
    description = models.TextField(blank=True)
    icon_class = models.CharField(max_length=100, default='fas fa-atom')
    display_order = models.IntegerField(default=0)
